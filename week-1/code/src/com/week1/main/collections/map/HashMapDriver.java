 ...
 * @author hsykrmn
 *
 *  @Note Anahtarlar ve Değerler Sıralı Değildir.

 *	kullanılan methodlar -> 
 *  put, keySet, values, entrySet, get, replace, remove,  isEmpty, size, containsValue, containsKey
 *  clear, putAll, putIfAbsent
 */
public class HashMapDriver {
	public static void run() {
		...
		String language = languages.get(5);
	    ...
	    /** entrySet -> map'in her entry'si aracılıgıyla elemanlarnda sırayla gezinebilriz */
